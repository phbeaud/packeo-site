      ...
      <div className="container-page relative flex-1 flex flex-col justify-center pb-16">
        <div className="animate-fade-in">
          <div className="section-label mb-8 md:mb-12 text-ink-300">
            <span className="text-ink-300">{t.hero.eyebrow}</span>
          </div>
        </div>
        ...
        >
          {t.hero.titleA}
          <br />
          <span className="text-ember">{t.hero.titleB}</span>
        </h1>
...
function FlowLines() {
  return (
    <svg className="absolute inset-0 w-full h-full pointer-events-none" preserveAspectRatio="none" viewBox="0 0 1200 800" fill="none" aria-hidden>
      <path d="M0 600 Q300 580 600 600 T1200 600" stroke="#E85D1F" strokeWidth="1" strokeOpacity="0.35" strokeDasharray="1200" style={{ animation: 'traceLine 6s ease-in-out infinite alternate' }} />
      <path d="M0 660 Q400 640 800 660 T1200 660" stroke="#FFFFFF" strokeWidth="1" strokeOpacity="0.12" strokeDasharray="1200" style={{ animation: 'traceLine 9s ease-in-out infinite alternate', animationDelay: '1.5s' }} />
