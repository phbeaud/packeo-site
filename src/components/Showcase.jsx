      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 min-h-[80vh]">
        <div className="lg:col-span-5 relative flex flex-col justify-between p-8 md:p-14 lg:p-20 overflow-hidden">
          ...
          <div
            ...
            style={{
              background:
                'radial-gradient(closest-side, rgba(232, 93, 31, 0.4), transparent 70%)',
            }}
            aria-hidden
          />
          ...
          <div className="relative">
            <div className="section-label text-ink-300 mb-8 reveal">
              <span className="text-ink-300">Sur le terrain</span>
            </div>
            <h2 className="reveal font-display font-semibold text-display-lg tracking-ultra-tight">
              L'emballage
              <br />
              <span className="text-ember">en mouvement.</span>
            </h2>
          </div>

          <div className="relative mt-12 lg:mt-0 max-w-md">
            <p
              className="reveal text-lg text-white/80 leading-relaxed"
              style={{ transitionDelay: '120ms' }}
            >
              Chaque jour, des milliers de cartons, palettes et conteneurs
              transitent dans une chaîne organisée — depuis l'usine jusqu'à
              votre quai.
            </p>
            <div
              className="reveal mt-10 flex items-center gap-6 text-white/60 text-[11px] uppercase tracking-[0.22em] font-medium"
        ...
        <div className="lg:col-span-7 relative min-h-[60vh] lg:min-h-0 overflow-hidden bg-ink-800">
          <img
            ...
            alt="Cartons et emballages en circulation"
